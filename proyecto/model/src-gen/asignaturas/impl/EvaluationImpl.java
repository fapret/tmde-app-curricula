 ...
 * </p>
 * <ul>
 *   <li>{@link asignaturas.impl.EvaluationImpl#getDate <em>Date</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EvaluationImpl extends MinimalEObjectImpl.Container implements Evaluation {
	...
	protected EClass eStaticClass() {
		return AsignaturasPackage.Literals.EVALUATION;
	}
	...
	public void setDate(Date newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsignaturasPackage.EVALUATION__DATE, oldDate, date));
	}
