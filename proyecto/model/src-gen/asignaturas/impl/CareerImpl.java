 ...
 * </p>
 * <ul>
 *   <li>{@link asignaturas.impl.CareerImpl#getName <em>Name</em>}</li>
 *   <li>{@link asignaturas.impl.CareerImpl#getPlan <em>Plan</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CareerImpl extends MinimalEObjectImpl.Container implements Career {
	...
	protected EClass eStaticClass() {
		return AsignaturasPackage.Literals.CAREER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsignaturasPackage.CAREER__NAME, oldName, name));
	}
