 ...
 * </p>
 * <ul>
 *   <li>{@link asignaturas.impl.SomeOfImpl#getN <em>N</em>}</li>
 *   <li>{@link asignaturas.impl.SomeOfImpl#getRequirement <em>Requirement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SomeOfImpl extends RequirementImpl implements SomeOf {
	/**
	...
	protected EClass eStaticClass() {
		return AsignaturasPackage.Literals.SOME_OF;
	}
	...
	public void setN(int newN) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsignaturasPackage.SOME_OF__N, oldN, n));
	}
