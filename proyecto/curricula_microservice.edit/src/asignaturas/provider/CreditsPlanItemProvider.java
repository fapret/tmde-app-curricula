		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CreditsPlan_MinCredits_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CreditsPlan_MinCredits_feature", "_UI_CreditsPlan_type"),
				 AsignaturasPackage.Literals.CREDITS_PLAN__MIN_CREDITS,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AsignaturasPackage.Literals.CREDITS_PLAN__GROUP_OF_SUBJECTS,
