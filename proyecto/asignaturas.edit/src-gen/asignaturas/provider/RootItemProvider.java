...
public class RootItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addFacultyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Root_Faculty_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Root_Faculty_feature", "_UI_Root_type"),
						AsignaturasPackage.Literals.ROOT__FACULTY, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AsignaturasPackage.Literals.ROOT__FACULTY,
