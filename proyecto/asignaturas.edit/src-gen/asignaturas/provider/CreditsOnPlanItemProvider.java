...
public class CreditsOnPlanItemProvider extends RequirementItemProvider {
	...
	protected void addCredPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_CreditsOnPlan_cred_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_CreditsOnPlan_cred_feature",
								"_UI_CreditsOnPlan_type"),
						AsignaturasPackage.Literals.CREDITS_ON_PLAN__CRED, true, false, false,
	...
	protected void addCreditsPlanPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_CreditsOnPlan_CreditsPlan_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_CreditsOnPlan_CreditsPlan_feature",
								"_UI_CreditsOnPlan_type"),
						AsignaturasPackage.Literals.CREDITS_ON_PLAN__CREDITS_PLAN, true, false, true, null, null,
						null));
	}
